...
return array (
  ...
  'navatech/yii2-roxymce' =>
  array (
    'name' => 'navatech/yii2-roxymce',
    'version' => '2.0.5.0',
    'alias' =>
    array (
      '@navatech/roxymce' => $vendorDir . '/navatech/yii2-roxymce/src',
    ),
    'bootstrap' => 'navatech\\roxymce\\Bootstrap',
  ),
  'navatech/yii2-navatech-base' =>
  array (
    'name' => 'navatech/yii2-navatech-base',
    'version' => '1.0.0.2',
    'alias' =>
    array (
      '@navatech/base' => $vendorDir . '/navatech/yii2-navatech-base/src',
    ),
  ),
  ...
  array (
    ...
    'alias' =>
    array (
      '@moonlandsoft/phpexcel' => $vendorDir . '/moonlandsoft/yii2-phpexcel',
    ),
  ),
  'phpoffice/phpexcel' =>
  array (
    ...
    'alias' =>
    array (
      '@phpoffice/phpexcel' => $vendorDir . '/phpoffice/phpexcel',
    ),
  ),
  ...
  array (
    'name' => 'brussens/yii2-bootstrap-select',
    'version' => '9999999-dev',
    'alias' =>
    array (
      '@brussens/bootstrap/select' => $vendorDir . '/brussens/yii2-bootstrap-select',
    ),
  ),
  'kartik-v/yii2-krajee-base' =>
  array (
