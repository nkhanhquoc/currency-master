        ...
        <div class="portlet-body">
            ...
            <div class="actions">
              ...
              <?php endif;?>
                ...
                <a href="/cost/export?id=<?= $model->id ?>" class="btn btn-outline btn-circle btn-sm btn-primary">Xuất hóa đơn</a>
...
trr+=     '<option value="18">Thu</option>';
trr+=     '<option value="19">Chi</option>';
trr+=   '</select>';
trr+=   '</td>';
trr+= '<td>';
