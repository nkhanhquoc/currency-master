    ...
    <div class="portlet light portlet-fit portlet-form bordered bill-form">
        ...
        <div class="portlet-body">
            <div class="form-body">
                    ...
                    <div class="row">
                      <h3 style="text-align:center">MUA BÁN QUÊ</h3>
                    </div>
            ...
            <div class="actions">
              ...
              <?php endif;?>
                ...
                <a href="/home-trading/export?id=<?= $model->id ?>" class="btn btn-outline btn-circle btn-sm btn-primary">Xuất hóa đơn</a>
