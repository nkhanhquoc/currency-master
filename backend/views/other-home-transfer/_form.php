    ...
    <div class="portlet light portlet-fit portlet-form bordered bill-form">
            ...
            <table class="table table-striped table-condensed">
              ...
              <?php foreach($trans as $k => $tran):?>
                <tr class="form-group">
                  ...
                  <td>
                     <?= $form->field($tran, 'real_value')->textInput(['class'=>'form-control','readonly'=>'readonly','name'=>'trans[real_value][]'])->label(false)?>
                  </td>
        ...
        <div class="actions">
          ...
          <?php endif;?>
            ...
            <a href="/other-home-transfer/export?id=<?= $model->id ?>" class="btn btn-outline btn-circle btn-sm btn-primary">Xuất hóa đơn</a>
